...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.vue3FormAnt = {}, global.Vue, global.createVue3Core, global.i18n, global.vueUtils, global.formUtils, global.validate, global.getDefaultFormState));
  ...
  var baseComponent$2 = {
    ...
    setup: function setup(props, _ref) {
      var attrs = _ref.attrs;
      return function () {
        return vue.h(vueUtils.resolveComponent('a-select'), _objectSpread2(_objectSpread2({}, attrs.multiple ? {
          mode: 'multiple'
        } : {}), attrs), {
          default: function _default() {
            return props.enumOptions.map(function (item, index) {
