...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('vue'), require('@lljj/vue3-form-core'), require('@lljj/vjsf-utils/i18n'), require('@lljj/vjsf-utils/vue3Utils'), require('@lljj/vjsf-utils/formUtils'), require('@lljj/vjsf-utils/schema/validate'), require('@lljj/vjsf-utils/schema/getDefaultFormState')) :
  typeof define === 'function' && define.amd ? define(['exports', 'vue', '@lljj/vue3-form-core', '@lljj/vjsf-utils/i18n', '@lljj/vjsf-utils/vue3Utils', '@lljj/vjsf-utils/formUtils', '@lljj/vjsf-utils/schema/validate', '@lljj/vjsf-utils/schema/getDefaultFormState'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.vue3FormNaive = {}, global.Vue, global.createVue3Core, global.i18n, global.vueUtils, global.formUtils, global.validate, global.getDefaultFormState));
}(this, (function (exports, vue, createVue3Core, i18n, vueUtils, formUtils, validate, getDefaultFormState) { 'use strict';
  ...
  var baseComponent = {
    ...
    setup: function setup(props, _ref) {
      ...
      return function () {
        return vue.h(vueUtils.resolveComponent('n-checkbox-group'), attrs, {
          default: function _default() {
            return vue.h(vueUtils.resolveComponent('n-space'), {
              itemStyle: 'display: flex'
            }, {
              default: function _default() {
                return props.enumOptions.map(function (item, index) {
                  return vue.h(vueUtils.resolveComponent('n-checkbox'), {
                    key: index,
                    value: item.value
                  }, {
                    default: function _default() {
  ...
  var baseComponent$1 = {
    ...
    setup: function setup(props, _ref) {
      var attrs = _ref.attrs;
      return function () {
        return vue.h(vueUtils.resolveComponent('n-radio-group'), attrs, {
          default: function _default() {
            return props.enumOptions.map(function (item, index) {
              return vue.h(vueUtils.resolveComponent('n-radio'), {
                key: index,
                value: item.value
              }, {
                default: function _default() {
  ...
  var baseComponent$2 = {
    ...
    setup: function setup(props, _ref) {
      var attrs = _ref.attrs;
      return function () {
        return vue.h(vueUtils.resolveComponent('n-select'), _objectSpread2({
  ...
  var baseComponent$3 = {
    ...
    setup: function setup(props, _ref) {
      ...
      return function () {
        ...
        return vue.h(vueUtils.resolveComponent('n-date-picker'), _objectSpread2(_objectSpread2({
  ...
  var baseComponent$5 = {
    ...
    setup: function setup(props, _ref) {
      ...
      return function () {
        ...
        return vue.h(vueUtils.resolveComponent('n-time-picker'), _objectSpread2(_objectSpread2({}, otherAttrs), {}, {
    ...
    setup: function setup(props, _ref) {
      ...
      return function () {
        ...
        var childVNode = _objectSpread2({
          default: function _default() {
            return vue.h(vueUtils.resolveComponent('n-button'), {
              type: 'primary'
            }, {
              default: function _default() {
        ...
        return vue.h(vueUtils.resolveComponent('n-upload'), data, childVNode);
      };
    }
  };
  ...
  var widgetComponents = {
    ...
    InputWidget: vueUtils.modelValueComponent('n-input'),
    ColorWidget: vueUtils.modelValueComponent('n-color-picker'),
    TextAreaWidget: vueUtils.modelValueComponent('n-textarea'),
    InputNumberWidget: vueUtils.modelValueComponent('n-input-number'),
    AutoCompleteWidget: vueUtils.modelValueComponent('n-auto-complete'),
    SliderWidget: vueUtils.modelValueComponent('n-slider'),
    RateWidget: vueUtils.modelValueComponent('n-rate'),
    SwitchWidget: vueUtils.modelValueComponent('n-switch')
  };
      ...
      form: vue.defineComponent({
        ...
        setup: function setup(props, _ref) {
          ...
          return function () {
            ...
            return vue.h(vueUtils.resolveComponent('n-form'), _objectSpread2(_objectSpread2({
              ref: formRef,
              model: model.value
      ...
      formItem: vue.defineComponent({
        ...
        setup: function setup(props, _ref2) {
          ...
          return function () {
            ...
            return vue.h(vueUtils.resolveComponent('n-form-item'), childAttrs, slots);
          };
        }
      }),
      button: 'n-button',
      ...
      popover: vue.defineComponent({
        setup: function setup(props, _ref3) {
          var attrs = _ref3.attrs,
              slots = _ref3.slots;
          return function () {
            return vue.h(vueUtils.resolveComponent('n-popover'), attrs, {
  ...
  var modelValueComponent = vueUtils.modelValueComponent;
  ...
  exports.modelValueComponent = modelValueComponent;
